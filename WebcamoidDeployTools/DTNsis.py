...
def createInstaller(globs,
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with open(nsiScript, 'w') as f:
            ...
            f.write('        Click OK to uninstall the older version or Cancel to cancel the installation." \\\n')
            f.write('        IDOK uninstall_previous\n')
            f.write('    Abort\n')
            f.write('    \n')
            f.write('    uninstall_previous:\n')
            f.write('        ClearErrors\n')
            f.write('        ExecWait \'"$R0" _?=$INSTDIR\'\n')
            f.write('    \n')
            ...
            f.write('        Click OK to uninstall the older version or Cancel to cancel the installation." \\\n')
            f.write('        IDOK uninstall_previous_user\n')
            f.write('    Abort\n')
            f.write('    \n')
            f.write('    uninstall_previous_user:\n')
            f.write('        ClearErrors\n')
            f.write('        ExecWait \'"$R0" _?=$INSTDIR\'\n')
            f.write('    \n')
            f.write('    continue_install:\n')
            f.write('\n')
